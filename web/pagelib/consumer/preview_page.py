...
CIPY_PATH = path + "data/plant_pos.csv"

MACHINE_PATH = path + "source/data_generation/dataset/machine_type.csv"

PLANT_PATH = path + "source/data_generation/dataset/plants.csv"

CHIP_PATH = path + "source/data_generation/dataset/chip_type.csv"
...
def preview_page():
    ...
    chip_img = Image.open(path + "images/chip_img.jpg")
    st.image(chip_img)
    ...
    plant_img = Image.open(path + "images/plant.jpg")
    ...
    machine_img = Image.open(path + "images/machine.jpeg")
