...
MACHINE_PATH = "web\source\data_generation\dataset\machine_type.csv"

PLANT_PATH = "web\source\data_generation\dataset\plants.csv"

CHIP_PATH = "web\source\data_generation\dataset\chip_type.csv"
...
def preview_page():
    ...
    chip_img = Image.open("web\images\chip_img.jpg")
    st.image(chip_img)
    ...
    plant_img = Image.open("web\images\plant.jpg")
    ...
    machine_img = Image.open("web\images\machine.jpeg")
