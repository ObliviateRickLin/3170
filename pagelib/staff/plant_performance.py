...
def plant_performance():
    ...
    Under this function, staff can see the monthly revenue change of the company on the line chart.\n
    3. Packages completion:\n
    Under this function, staff can see the change in the number of packages received and completed by the company each month on the AREA chart.\n
    """)
    st.text('\n')
    st.text('\n')
    st.text('\n')
